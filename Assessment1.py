...
comic_image = PhotoImage(file="C:/Users/User/Documents/Coding/unnamed2.png")
...
amount_entry = ttk.Entry(bottom_frame, show="*", textvariable=amount, justify=CENTER, validate='all', validatecommand=(amount_entry_command, '%S'))
